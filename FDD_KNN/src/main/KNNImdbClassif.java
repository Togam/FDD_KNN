...
import dao.CsvMovieDaoImdbClassif;
...
class KNNImdbClassif {
	...
	public static void main(String args[]) throws IOException {
		...
		CsvMovieDaoImdbClassif daoRentab = new CsvMovieDaoImdbClassif(
				new File(
						"/home/m1miage/six/Documents/FDD/projet/predictionIMDBdisc.csv"));
		movieList = daoRentab.findAllMovies();

		// data about unknown movie
		String[] query_string = { "'long'","'peu populaire'","'peu populaire'","'peu connus'"};
		long[] query = ParseLigne.parseLigneImdb(query_string);
